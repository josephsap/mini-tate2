...
function AnnotationWrapper(_a) {
    ...
    var AnnotationToEdit = react_1["default"].forwardRef(function () { return (react_1["default"].createElement(EditableAnnotation_1["default"], { annotationTypes: annotationTypes, handleCancelEdit: function () {
            handleCancelEdit();
            dispatch((0, currAnno_1.setTop)(top));
            dispatch((0, currAnno_1.setWidth)(width));
            dispatch((0, currAnno_1.setLeft)(left));
    ...
    return (react_1["default"].createElement(StaticAnnotation_1["default"], { height: height, left: left, onClick: function () { return handleEditAnnotation(name); }, options: options, top: top, width: width, name: name, types: annotationTypes, type: type, rainbowMode: rainbowMode, setHoverActiveAnno: setHoverActiveAnno, onHoverFromList: onHoverFromList }));
}
